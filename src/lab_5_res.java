...
public class lab_5_res {
    static @NotNull List<Double> res1(){
        ...
        while (accuracy.get(i)>eps) {
            ...
            accuracy.add(1/3*Math.abs(lab_5.scale1(i, a, b)- lab_5.scale1(2 * i, a, b)));
    ...
    static @NotNull List<Double> res2(){
        ...
        while (accuracy.get(i)>eps) {
            i++;
            accuracy.add(1/3*Math.abs(lab_5.scale2(i, a, b)- lab_5.scale2(2 * i, a, b)));
    ...
    static @NotNull List<Double> res3(){
        ...
        while (accuracy.get(i)>eps) {
            i++;
            accuracy.add(1/3*Math.abs(lab_5.scale3(i, a, b)- lab_5.scale3(2 * i, a, b)));
    ...
    static @NotNull List<Double> res4(){
        ...
        while (accuracy.get(i)>eps) {
            i++;
            accuracy.add(1/3*Math.abs(lab_5.scale4(i, a, b)- lab_5.scale4(2 * i, a, b)));
    ...
    static @NotNull List<Double> res5(){
        ...
        while (accuracy.get(i)>eps) {
            i++;
            accuracy.add(1/3*Math.abs(lab_5.scale5(i, a, b)- lab_5.scale5(2 * i, a, b)));
